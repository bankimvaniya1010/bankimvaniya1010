<%@ Page Language="C#" AutoEventWireup="true" CodeFile="universitydetails_CreateN.aspx.cs" Inherits="admin_universitydetails_CreateN" MasterPageFile="~/admin/admin.master"%>
...
<!------ Include the above in your HEAD tag ---------->
    ...
    <div class="container page__container">
        ...
        <h1 class="h2">EDIT INSTITUTION</h1>
                                            ...
                                            <div runat="server" id="courseDiv" style="display: block;">
                                              <h5>COURSES </h5>
                                                <div id="new">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <asp:CheckBoxList runat="server" ID="CheckBoxList2" RepeatColumns="2" Font-Size="Small" CssClass="myCheckboxCss" RepeatDirection="Vertical">
                                                            </asp:CheckBoxList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <asp:CheckBoxList runat="server" ID="CheckBoxList3" RepeatColumns="3" Font-Size="Small" RepeatDirection="Vertical">
                                                            </asp:CheckBoxList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
