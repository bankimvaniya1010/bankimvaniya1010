<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_exampaper.aspx.cs" Inherits="admin_edit_exampaper" MasterPageFile="~/admin/admin.master"%>
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-6">
                                       ...
                                       <asp:HyperLink runat="server" ID="studentFileUploadLink" Target="_blank"></asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" id="hidcheckingguidfilepathpath" runat="server" />
                                        <asp:HyperLink runat="server" ID="checkingguidfilepathLink" Target="_blank"></asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>
