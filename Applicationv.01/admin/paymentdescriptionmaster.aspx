<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paymentdescriptionmaster.aspx.cs" Inherits="admin_paymentdescriptionmaster" MasterPageFile="~/admin/admin.master"%>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Payment Description</li>
        </ol>
        <h1 class="h2">Payment Description</h1>

        <div class="card">

            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvPaymentDescription" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        DataKeyNames="id"
                        AllowPaging="True"
                        CellPadding="3" BorderStyle="None" BorderWidth="1px" CellSpacing="2"
                        PageSize="25"
                        OnDataBound="gvPaymentDescription_DataBound" OnRowCancelingEdit="gvPaymentDescription_RowCancelingEdit" OnRowCommand="gvPaymentDescription_RowCommand" OnRowDataBound="gvPaymentDescription_RowDataBound" OnRowDeleted="gvPaymentDescription_RowDeleted" OnRowDeleting="gvPaymentDescription_RowDeleting" OnRowEditing="gvPaymentDescription_RowEditing" OnRowUpdated="gvPaymentDescription_RowUpdated" OnRowUpdating="gvPaymentDescription_RowUpdating" OnPageIndexChanging="gvPaymentDescription_PageIndexChanging">
                        ...
                        <asp:BoundField DataField="id" HeaderText="ID" InsertVisible="False"
                            ...
                            <asp:TemplateField HeaderText="Payment Description">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtDescription"  CssClass="form-control" TextMode="MultiLine" runat="server" Text='<%# Bind("payment_description") %>'></asp:TextBox>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblDescription" runat="server" Text='<%# Bind("payment_description") %>'></asp:Label>
    ...
    <script>
		...
		$(document).ready(function () {
            ...
            $('#paymentdescriptionmaster').addClass('active');
        });
	</script>
</asp:Content>
