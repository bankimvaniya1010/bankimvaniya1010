<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_chec_assignment_build.aspx.cs" Inherits="admin_ec_chec_assignment_build" MasterPageFile="~/admin/admin.master"%>
            ...
            <div id="showbuildexamDiv" runat="server" style="display: none">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    ...
                                                    <asp:TextBox ID="txtmarks2" runat="server" class="form-control" AutoCompleteType="Disabled">  </asp:TextBox>  
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="" id="marksDiv" runat="server">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3" style="font-size: x-large; margin-top: 0%;">
                            /<%=lblExamfinalmarks %>
                        </div>
                    </div>
