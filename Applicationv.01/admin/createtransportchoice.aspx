<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createtransportchoice.aspx.cs" Inherits="admin_createtransportchoice" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Create Transport Choice Plan</li>
        </ol>

        <h1 class="h2">Create Transport Choice Plan</h1>
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    ...
                    <div class="form-group row">
                        <label for="TransportName" class="col-sm-3 col-form-label form-label">Transport Choice Name</label>
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:DropDownList ID="ddlTransport" name="ddlTransport" runat="server" class="form-control"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="Transportfee" class="col-sm-3 col-form-label form-label">Fee</label>
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <input id="txtFee" type="text" runat="server" class="form-control" placeholder="Transport Fee" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            var Transport = $('#<%=ddlTransport.ClientID%>').val();
            if (Transport == 0 || isNaN(parseInt(Transport))) {
                alert("Please select transport choice");
                return false;
            }
