...
public partial class admin_ec_class_create_assign_instructor_master : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(webURL + "admin/ec_class_create_assign_instructor.aspx", true);
    }
