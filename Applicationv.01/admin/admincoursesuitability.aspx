<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admincoursesuitability.aspx.cs" Inherits="admin_coursesuitability" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Course Suitability Master</li>
        </ol>
        <h1 class="h2">Course Suitability Master</h1>
                ...
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvAddressProof" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        ...
                        <EmptyDataTemplate>
                            <tr>
                                <th scope="col">ID</th>
                                <th scope="col">Course Suitability</th>
                                <th scope="col"></th>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Course Suitability" SortExpression="coursetype">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtDescription" CssClass="form-control" TextMode="MultiLine" runat="server" Text='<%# Bind("coursetype") %>' ></asp:TextBox>
                                    <asp:RequiredFieldValidator runat='server' ID='requiredDescEdit' ValidationGroup='<%# "Group_" + Container.DataItemIndex %>' Display="Dynamic" ErrorMessage='Course Suitability Cannot Be Empty' ControlToValidate='txtDescription' />
                                </EditItemTemplate>

                                <FooterTemplate>

                                    <asp:TextBox ID="txtDescription1" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat='server' ID='requiredDescFooter' ValidationGroup='<%# "GroupF_" + Container.DataItemIndex %>' ErrorMessage='Course Suitability Cannot Be Empty' ControlToValidate='txtDescription1' />
                                </FooterTemplate>
    ...
    <script>
        function validateEmptyRow() {
            if (!$("#ContentPlaceHolder1_gvAddressProof_txtEmptyRecordDescription").is(':hidden') && $("#ContentPlaceHolder1_gvAddressProof_txtEmptyRecordDescription").val() == "") {
                alert("Course Suitability Cannot Be Empty");
                return false;
            }
