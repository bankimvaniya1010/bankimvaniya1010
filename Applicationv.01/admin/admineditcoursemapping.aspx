<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admineditcoursemapping.aspx.cs" Inherits="admin_editcoursemapping" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="container page__container">
                                                ...
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <asp:RadioButtonList ID="rblActiveStatus" runat="server">
                                            ...
                                            <div id="Divtab2" runat="server">
                                                ...
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <asp:CheckBoxList runat="server" ID="chkBroadFieldofStudy" RepeatColumns="2" Font-Size="Small">
                                                                </asp:CheckBoxList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <asp:CheckBoxList ID="chkNarrowFieldofStudy" RepeatColumns="2" Font-Size="Small" runat="server"></asp:CheckBoxList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row Class" style="display: none">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtGroup" type="text" runat="server" class="form-control" placeholder="Grade" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="Divtab3" runat="server">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlCourseImage" Target="_blank"></asp:HyperLink>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlfpCourseAudioVideo" Target="_blank"></asp:HyperLink>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlCourseBrochure" Target="_blank"></asp:HyperLink>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtLinktoWebPageURL" class="form-control" TextMode="MultiLine" runat="server" Style="width: 600px; height: 140px"></asp:TextBox>
                                                ...
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <asp:CheckBoxList runat="server" ID="chkCourseSuitablefor" RepeatColumns="2" Font-Size="Small">
                                                                </asp:CheckBoxList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row ShortCourse Institution Class" style="display: none">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <asp:CheckBoxList runat="server" ID="chkLocationsCampusBranch" RepeatColumns="2" Font-Size="Small">
                                                                </asp:CheckBoxList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:TextBox runat="server" ID="txtAverageNumberParticipantsClassSize" CssClass="form-control">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList runat="server" ID="rblHousingAvailable" CssClass="form-control">
                                                                    <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                                    <asp:ListItem Value="No">No</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                ...
                                                <div class="form-group row Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:TextBox runat="server" ID="txtAcceptanceRate" CssClass="form-control">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList runat="server" ID="rblDisabilityServicesAvailable" CssClass="form-control">
                                                                    <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                                    <asp:ListItem Value="No">No</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                ...
                                                <div class="form-group row online" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList runat="server" ID="rblSelfPaced" CssClass="form-control">
                                                                    <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                                    <asp:ListItem Value="No">No</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                ...
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList runat="server" ID="rblCertificationEarned">
                                                                    <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                                                    <asp:ListItem Value="No">No</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                            ...
                                            <div id="Divtab4">
                                                <div class="form-group row online ShortCourse Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtFee" runat="server" class="form-control" placeholder="Fee" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:TextBox ID="txtFeePaymentMode" runat="server" class="form-control" placeholder="Application/Enrollment Fee" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <asp:CheckBoxList ID="chkFeePaymentMode" runat="server" RepeatColumns="2" Font-Size="Small" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="form-group rowInstitution" style="display: none;">
                                                    <label for="uniAffiliation" class="col-sm-3 col-form-label form-label">
                                                        Funding Available
                                                    </label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div id="Divtab5">
                                                <div class="form-group row online Institution Class" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList ID="rblEligibleforGovtSubsidy" runat="server">
                                                ...
                                                <div class="form-group row online Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList ID="rblEligibleforScholarship" runat="server">
                                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlInstructorDirectorImage1" Target="_blank"></asp:HyperLink>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlInstructorDirectorImage2" Target="_blank"></asp:HyperLink>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlInstructorDirectorImage3" Target="_blank"></asp:HyperLink>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlInstructorDirectorImage4" Target="_blank"></asp:HyperLink>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:HyperLink runat="server" ID="hlInstructorDirectorImage5" Target="_blank"></asp:HyperLink>
                                            ...
                                            <div id="DivTab9">
                                                ...
                                                <div class="form-group row  Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList ID="rblSubjectQualification" runat="server">
                                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                ...
                                                <div class="form-group row  Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList ID="rblEnglishLanguageCompetency" runat="server">
                                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                ...
                                                <div class="form-group row  Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList ID="rblGraduateAdmissionTest" runat="server">
                                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                ...
                                                <div class="form-group row  Institution" style="display: none;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButtonList ID="rblIsInterview" runat="server">
                                                                    <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                                    <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
      ...
      <style src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.min.css"></style>
    ...
    <script type="text/javascript">
       ...
       // $('#<%=txtStartDateIntakeDate.ClientID %>').datepicker({ minDate: new Date(), dateFormat: 'yy-mm-dd' });
        ...
        function validateUploadedimg2(filepath, hlFilepath) {
            if (filepath != "") {
                var fileExtension = filepath.substring(filepath.lastIndexOf(".") + 1).toString().toLowerCase();
                if (fileExtension != "jpg" && fileExtension != "jpeg" && fileExtension != "png") {
                    alert("Invalid file. Please select file of type jpg, jpeg,png");
        ...
        function validateForm() {
            ...
            else if ($("#<%=fpCourseImage.ClientID%>").val() != "" && !validateUploadedimg($("#<%=hlCourseImage.ClientID%>").val())) { }
        ...
        function loadTimeZoneList() {
            ...
            var timezonee = document.getElementById("ContentPlaceHolder1_hidTimeZone");
            for (var i = 0; i < objSelect.options.length; i++) {
                if (objSelect.options[i].value == timezonee.value) {
        ...
        function bydefaultcheck(broadID, Ischeck) {
            $.ajax({
                type: "POST",
                url: "admineditcoursemapping.aspx/GetNarrow",
        ...
        function byDeafultCheckDetailed(narrowID, Ischeck) {
            $.ajax({
                type: "POST",
                url: "admineditcoursemapping.aspx/GetDetailed",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
