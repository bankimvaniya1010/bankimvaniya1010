<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminskillsmaster.aspx.cs" Inherits="admin_skillsmaster" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Skills Master Master</li>
        </ol>
        <h1 class="h2">Skills Master Master</h1>
                ...
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvAddressProof" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Skills" SortExpression="coursetype">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtDescription" CssClass="form-control" TextMode="MultiLine" runat="server" Text='<%# Bind("coursetype") %>' ></asp:TextBox>
                                    <asp:RequiredFieldValidator runat='server' ID='requiredDescEdit' ValidationGroup='<%# "Group_" + Container.DataItemIndex %>' Display="Dynamic" ErrorMessage='Skills Cannot Be Empty' ControlToValidate='txtDescription' />
                                </EditItemTemplate>

                                <FooterTemplate>

                                    <asp:TextBox ID="txtDescription1" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat='server' ID='requiredDescFooter' ValidationGroup='<%# "GroupF_" + Container.DataItemIndex %>' ErrorMessage='Skills Cannot Be Empty' ControlToValidate='txtDescription1' />
                                </FooterTemplate>
