<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="ec_edit_assignstudymaterial.aspx.cs" Inherits="admin_ec_edit_assignstudymaterial" %>
...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="ec_assignclass_mange.aspx">Mange Study Materials</a></li>
                        ...
                        <div class="tab-pane active" id="first">
                            ...
                            <div class="form-group row" id="group">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <asp:DropDownList runat="server" ID="ddlgrade" class="form-control" style="width:160%" OnSelectedIndexChanged="ddlgrade_SelectedIndexChanged" AutoPostBack="true" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" id="examsubject">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <asp:DropDownList runat="server" ID="ddlsubject" class="form-control" style="width:160%"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" id="mode">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <asp:DropDownList runat="server" ID="ddlmode" style="width:160%" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlmode_SelectedIndexChanged">
                             ...
                             <div class="form-group row" id="grade">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <asp:DropDownList runat="server" ID="ddlclass" style="width:160%" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" id="studrymaterial">
                                <label for="name" class="col-sm-3 col-form-label form-label">Select Study Materials</label>
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="col-md-8">
        ...
        function GenerateMaterialControl() {
            if (materialData != null && materialData != undefined && materialData.length > 0) {
                ...
                $.each(materialData, function (ind, item) {
                    ...
                    html = html.replaceAll('@value@', item.asmd_material_id);
                    html = html.replaceAll("@s_value@", item.asmd_start_date);
                    html = html.replaceAll("@p_value@", item.asmd_stop_time);
                    html = html.replaceAll('@material_name@', item.material_name);
                    ...
                    start_id_for_utc = item.asmd_material_id;
