<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outcome_master.aspx.cs" Inherits="admin_outcome_master" MasterPageFile="~/admin/admin.master"%>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Career Outcome Master</li>
        </ol>
        <h1 class="h2">Career Outcome Master</h1>

        <div class="card">

            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvoutcomes" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        DataKeyNames="id"
                        AllowPaging="True"
                        CellPadding="3" BorderStyle="None" BorderWidth="1px" CellSpacing="2"
                        PageSize="25"
                        OnDataBound="gvoutcomes_DataBound" OnRowCancelingEdit="gvoutcomes_RowCancelingEdit" OnRowCommand="gvoutcomes_RowCommand" OnRowDataBound="gvoutcomes_RowDataBound" OnRowDeleted="gvoutcomes_RowDeleted" OnRowDeleting="gvoutcomes_RowDeleting" OnRowEditing="gvoutcomes_RowEditing" OnRowUpdated="gvoutcomes_RowUpdated" OnRowUpdating="gvoutcomes_RowUpdating" OnPageIndexChanging="gvoutcomes_PageIndexChanging">
    ...
    <script>
        function validateEmptyRow() {
            if (!$("#ContentPlaceHolder1_gvoutcomes_txtEmptyRecordDescription").is(':hidden') && $("#ContentPlaceHolder1_gvoutcomes_txtEmptyRecordDescription").val() == "") {
		...
		$(document).ready(function () {
            ...
            $('#careeroutcomesmaster').addClass('active');
        });
	</script>
</asp:Content>
