<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminuniversitywisetooltips.aspx.cs" Inherits="admin_adminuniversitywisetooltips" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="conten1" runat="server">
    ...
    <div class="container page__container">
        ...
        <h1 class="h2">Admin University Wise Add/Edit ToolTips</h1>
