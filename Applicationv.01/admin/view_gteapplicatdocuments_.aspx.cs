...
public partial class admin_view_gteapplicatdocuments_ : System.Web.UI.Page
{
    int universityid = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(Request.QueryString["universityid"]))
            Response.Redirect(webURL + "admin/login.aspx", true);
        else
            universityid = Convert.ToInt32(Request.QueryString["universityid"].ToString());
