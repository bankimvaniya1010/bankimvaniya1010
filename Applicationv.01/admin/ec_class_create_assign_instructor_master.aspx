<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_class_create_assign_instructor_master.aspx.cs" Inherits="admin_ec_class_create_assign_instructor_master" MasterPageFile="~/admin/admin.master"%>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">ASSIGN INSTRUCTOR(S)</li>
        </ol>
            ...
            <div class="media align-items-center">
                <div class="form-row">
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="btn_addnew" runat="server" Text="Assign Instructor(s) to a Class" CssClass="btn btn-success" OnClick="btn_addnew_Click" />
                                <br />
                            </td>
                        </tr>
