<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewinfo.aspx.cs" Inherits="admin_viewinfo" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">View Applicant Details</li>
        </ol>
        <h1 class="h2">View Applicant Details </h1>
                    ...
                    <div class="accordion" id="review">
                        ...
                        <div class="card z-depth-0 bordered">
                            ...
                            <div id="EducationDetails" class="collapse" aria-labelledby="review4" data-parent="#review">
                                ...
                                <% if ((objEdu.Count > 0) && (objEdu[0].ishighschooldone == 1))
                                    {%>
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-highschool">
                                        <div class="form-row">
                                ...
                                <%}
                                    if ((objEdu.Count > 0) && (objEdu[0].issecondarydone == 1))
                                    {%>
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-highschool">
                                        <div class="form-row">
                                ...
                                <%}
                                    if ((objEdu.Count > 0) && (objEdu[0].ishighereducation == 1))
                                    {
                                ...
                                <%}
                                    ...
                                    if ((objEdu.Count > 0) && (objEdu[0].isdiplomadone == 1))
                                    { %>
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-highschool">
                                        <div class="form-row">
