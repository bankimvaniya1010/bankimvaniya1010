<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rejectionreasonmaster.aspx.cs" Inherits="admin_rejectionreasonmaster" MasterPageFile="~/admin/admin.master"%>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Rejection Reason Master</li>
        </ol>
        <h1 class="h2">Rejection Reason Master</h1>
        ...
        <div class="card">
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvRejectionReason" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        DataKeyNames="id"
                        AllowPaging="True"
                        CellPadding="3"
                        PageSize="25"
                        BorderStyle="None"
                        BorderWidth="1px"
                        CellSpacing="2" OnDataBound="gvRejectionReason_DataBound" OnRowCancelingEdit="gvRejectionReason_RowCancelingEdit" OnRowCommand="gvRejectionReason_RowCommand" OnRowDataBound="gvRejectionReason_RowDataBound" OnRowDeleted="gvRejectionReason_RowDeleted" OnRowDeleting="gvRejectionReason_RowDeleting" OnRowEditing="gvRejectionReason_RowEditing" OnRowUpdated="gvRejectionReason_RowUpdated" OnRowUpdating="gvRejectionReason_RowUpdating" OnPageIndexChanging="gvRejectionReason_PageIndexChanging">
    ...
    <script>
		...
		$(document).ready(function () {
            ...
            $('#rejectionreason').addClass('active');
        });
	</script>
</asp:Content>
