<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gte_certificateN.aspx.cs" Inherits="admin_gte_certificateN" %>
...
<html lang="en">
  ...
  <body>
    ...
    <div runat="server" id="btnDiv" class="form-row justify-content-between" style="display: none;margin-left: 810px;width: 50%;padding: 10px;">
            ...
            <asp:Button ID="btnDownload" runat="server" CssClass="btn btn-success" Text="Download Certificate" OnClick="btnDownload_Click" Visible="false"/>
        </div>
            ...
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0" class="first-row-table">
                        <tr class="first-row">
                            <td class="min-20">
                                <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/logo.png" class="cer-logo">
                            </td>
                            <td class="min-60">
            ...
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0" class="usr-info-table">
                        <tr>
                            <td class="lft-ttl"><img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/txt1.png"></td>
                            <td>
            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="lft-ttl">
                               <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/txt2.png"> 
                            </td>
            ...
            <tr>
                <td class="pb-30">
                    <table cellpadding="0" cellspacing="0" cl>
                        <tr>
                            <td class="lft-ttl">
                                <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/txt3.png">
                            </td>
                            <td>
                                        ...
                                        <td>
                                            <table cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/id-passed.png" class="id-check-p-f">
                                                    </td>
                                                    <td>
                                                        <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/assessment-passed.png" class="assessment-check-p-f">
                                                    </td>
                                                    <td>
                                                        <div class="cr-sgn-wrpr">
                                                            <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/gteCertificate_images/sgn.png">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
