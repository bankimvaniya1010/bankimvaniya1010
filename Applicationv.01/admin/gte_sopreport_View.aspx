...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gte_sopreport_View.aspx.cs" Inherits="admin_gte_sopreport_View" MasterPageFile="~/admin/admin.master"%>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        ...
        <h1 class="h2">STATEMENT OF PURPOSE FOR <%=FirstName%> <%=MiddleName%> <%=FamilyName%></h1>
...
<br />
                        ...
                        <div>After I complete my studies in Australia, <%=Answer_to_Question_18_Section_2 %></div><br/>
                        <div>My English language competencies are <%=Answer_to_Question_17_Section_2 %></div>
  ...
  <br />
                        ...
                        <div style="padding-left: 76%;">Yours sincerely,</div>
