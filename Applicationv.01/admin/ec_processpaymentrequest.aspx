<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_processpaymentrequest.aspx.cs" Inherits="admin_ec_processpaymentrequest" MasterPageFile="~/admin/admin.master"%>
                   ...
                   <asp:GridView ID="paymentRequestGridView" CssClass="table" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="false" CellPadding="3"
                       ...
                       <Columns>
                           ...
                           <asp:TemplateField HeaderText="Class Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblclassname" runat="server" Text='<%# Bind("class_id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
