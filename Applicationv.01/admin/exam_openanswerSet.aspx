...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                ...
                <div class="tab-content card-body">
                    <div class="table-responsive" data-toggle="lists" data-lists-values='["name"]'>
                        <asp:GridView ID="GridView" CssClass="table" runat="server" AutoGenerateColumns="False" ShowFooter="false" CellPadding="3"
                            ...
                            CellSpacing="2" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found" OnRowEditing="GridView_RowEditing" OnPageIndexChanging="GridView_PageIndexChanging">
    ...
    <script>
        function validateUploadedFile(typeid, filepath) {
            if (filepath == "") {
        ...
        function validateForm2() {
            ...
            else if ($("#<%=uploadcheckingfile.ClientID%>").val() == "" && !validateUploadedFile(5, $("#<%=uploadcheckingfile.ClientID%>").val())) { }
            ...
            else if ($("#<%=ddltype.ClientID%>").val() != "0" && $("#<%=ddltype.ClientID%>").val() != 1 && !validateUploadedFile($("#<%=ddltype.ClientID%>").val(), $("#<%=fileupload.ClientID%>").val())) { }
