<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tooltipsaddedit.aspx.cs" Inherits="admin_addtooltips" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="conten1" runat="server">
    ...
    <div class="container page__container">
        ...
        <h1 class="h2">Student Add/Edit ToolTips</h1>
