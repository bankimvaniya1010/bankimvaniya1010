<%@ Page Language="C#" AutoEventWireup="true" CodeFile="educationverificationcontactmaster.aspx.cs" Inherits="admin_educationverificationcontactmaster" MasterPageFile="~/admin/admin.master" %>
        ...
        <div class="card">
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvEducationVerificationContact" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        DataKeyNames="id"
                        AllowPaging="True"
                        CellPadding="3"
                        PageSize="25"
                        BorderStyle="None"
                        BorderWidth="1px"
                        CellSpacing="2" OnDataBound="gvEducationVerificationContact_DataBound" OnRowCancelingEdit="gvEducationVerificationContact_RowCancelingEdit" OnRowCommand="gvEducationVerificationContact_RowCommand" OnRowDataBound="gvEducationVerificationContact_RowDataBound" OnRowDeleted="gvEducationVerificationContact_RowDeleted" OnRowDeleting="gvEducationVerificationContact_RowDeleting" OnRowEditing="gvEducationVerificationContact_RowEditing" OnRowUpdated="gvEducationVerificationContact_RowUpdated" OnRowUpdating="gvEducationVerificationContact_RowUpdating">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                ...
                                <FooterTemplate>
                                    ...
                                    <asp:TextBox ID="txtDescriptionFooter" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
