<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="ec_create_assignstudymaterial.aspx.cs" Inherits="ec_create_assignstudymaterial" %>
                            ...
                            <div>
                                ...
                                <div class="form-group row" id="grade">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <asp:DropDownList runat="server" ID="ddlclass" class="form-control" style="width:160%;"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
