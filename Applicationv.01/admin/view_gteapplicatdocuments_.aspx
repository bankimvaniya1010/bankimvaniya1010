<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_gteapplicatdocuments_.aspx.cs" Inherits="admin_view_gteapplicatdocuments_" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="<%=VirtualPathUtility.ToAbsolute("~/assets/dashboard/css/app.css")%>" />
</head>
<body>
