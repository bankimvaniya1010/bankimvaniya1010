<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_editclass.aspx.cs" Inherits="admin_ec_editclass" MasterPageFile="~/admin/admin.master"%>
    ...
    <div class="container page__container">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <asp:HiddenField runat="server" ID="Hidintructionfile"/>
                                          <asp:HyperLink runat="server" ID="intructionfileLink" Target="_blank"></asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <%if (gradediploma.Count > 0)
                                        {
                                            ...
                                            {
                                    %>
                        <div class="form-group row" id="date_<%=gradediploma[i].RecordID %>">
                            <label for="startdate" class="col-sm-3 col-form-label form-label" style="margin-top: 20px;">Start Date</label><div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-5" style="margin-top: 20px;">
                                        <label><%=Convert.ToDateTime(gradediploma[i].startdate).ToString("dd/MM/yyyy") %></label>
                                        <div class="col-md-1" style="margin-top: 19px;">
                                            <input id="btnRemove" type="button" class="form-control" value="x" onclick="ConfirmOnDelete('<%=gradediploma[i].RecordID%>','<%=gradediploma[i].startdate%>');">
                                            <%--<a onclick="ConfirmOnDelete('<%=gradediploma[i].RecordID%>');" href="javascript:void(0)">X</a>--%>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <label for="deadline" class="col-sm-3 col-form-label form-label" style="margin-top: 20px;">Booking Deadline Date & Time</label>
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label><%=gradediploma[i].DeadlineDate %></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <%if (gradediploma.Count > 0)
                                        {
                                            ...
                                            {
                                    %>
                                    <tr id="<%=gradediploma[i].RecordID %>">
                                        <td scope="col">START DATE</td>
                                        <td>
                                            <%=gradediploma[i].startdate %>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td scope="col">BOOKING DEADLINE DATE & TIME</td>
                                        <td>
                                            <%=gradediploma[i].DeadlineDate %>
                                        </td>
                                        <td>
                                            <a onclick="ConfirmOnDelete('<%=gradediploma[i].RecordID%>','<%=gradediploma[i].startdate%>');" href="javascript:void(0)">Delete</a>
                                        </td>
                                    </tr>
       ...
       <script>
           ...
           function validateUploadedFile(filepath) {
               var hidfilepath = $("#<%=Hidintructionfile.ClientID%>").val();
               if (filepath == "")
        ...
        function init()
           ...
           function ConfirmOnDelete(recordID,startdate) {
               if (confirm("Are you sure wants to delete record of " + startdate + "")) {

                $.ajax({
                    type: "POST",
                    url: "ec_editclass.aspx/RemoveSubjectData",
