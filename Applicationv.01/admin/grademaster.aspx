<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grademaster.aspx.cs" Inherits="admin_grademaster" MasterPageFile="~/admin/admin.master" %>
        ...
        <div class="card">
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvGrade" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        DataKeyNames="id"
                        AllowPaging="True"
                        CellPadding="3"
                        PageSize="25"
