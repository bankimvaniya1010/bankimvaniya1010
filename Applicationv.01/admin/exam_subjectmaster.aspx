<%@ Page Language="C#" AutoEventWireup="true" CodeFile="exam_subjectmaster.aspx.cs" Inherits="admin_exam_subjectmaster" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script>
		...
		$(document).ready(function () {
            ...
            $('#examsubjectmaster').addClass('active');
        });
	</script>
</asp:Content>
