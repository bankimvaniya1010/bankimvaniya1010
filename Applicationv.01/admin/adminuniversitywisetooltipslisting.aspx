<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminuniversitywisetooltipslisting.aspx.cs" Inherits="admin_adminuniversitywisetooltipslisting" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="conten1" runat="server">
    ...
    <div class="container page__container">
        ...
        <h1 class="h2">Admin Institution Wise Tooltips Listing</h1>
         <div class="media align-items-center">  
            <div class="form-row">
                <a href="adminuniversitywisetooltips.aspx" class="btn btn-success">Add New</a>                                      
            </div>
        </div>
        <div class="card">
    ...
    <script>
		$(document).ready(function () {
            ...
            $('#adminuniversitywisetooltipslisting').addClass('active');
        });
	</script>
</asp:Content>
