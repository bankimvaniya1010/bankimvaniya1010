<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_truefalse_create.aspx.cs" Inherits="admin_ec_truefalse_create" MasterPageFile="~/admin/admin.master"%>
...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="container page__container">
        ...
        <h1 class="h2">CREATE A TRUE OR FALSE QUESTION</h1>
        <div class="">
                    ...
                    <div class="tab-pane active" id="first">
                        ...
                        <div class="form-group row" id="classname">
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input id="txtanswer1" runat="server" type="text" class="form-control" autocomplete="off" disabled="disabled" value="True">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row" id="classdescription">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input id="txtanswer2" runat="server" type="text" class="form-control" autocomplete="off" disabled="disabled" value="False">
                                    </div>
                                </div>
                            </div>
                        </div>
