<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createhealthinsurance.aspx.cs" Inherits="admin_createhealthinsurance" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Create Health Insurance Plan</li>
        </ol>

        <h1 class="h2">Create Health Insurance Plan</h1>
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    ...
                    <div class="form-group row">
                        <label for="InsuranceName" class="col-sm-3 col-form-label form-label">Health Insurance Name</label>
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-md-6">
