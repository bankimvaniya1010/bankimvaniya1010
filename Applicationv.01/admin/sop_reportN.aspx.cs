...
public partial class admin_sop_reportN : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["applicantId"] == null || Request.QueryString["applicantId"].ToString() == "" || Request.QueryString["downloadPdf"] == null || Request.QueryString["downloadPdf"].ToString() == "")
        {
        }
        else
        {
            ...
            if (downloadPdf == 0 || (downloadPdf == 1 && Request.QueryString["token"] != null && Request.QueryString["token"].ToString() == "YKUcfdhNWwp17azByk"))
            {
                showContent();
            }
        }
    ...
    {
        if (downloadPdf == 1 && Request.QueryString["token"] != null && Request.QueryString["token"].ToString() == "YKUcfdhNWwp17azByk")
        {
            int applicantId = 0;
    ...
    private void SetString(int UserID, int universityID)
    {
        ...
        {
            var Countryapplyingtostudy = applicantdetails.countryofeducationInstitution;
            ...
            {
                if (applicantdetails != null && applicantdetails.nationality != null)
                {
                    ViewState["nationality"] = objCommon.GetCountryDiscription(Convert.ToInt32(applicantdetails.nationality));
                    nationality = objCommon.GetCountryDiscription(Convert.ToInt32(applicantdetails.nationality));
                }
            ...
            if (applicantdetails != null)
            {
                ...
                gteEvalution_date = clarification_response_submittedDate.ToString("dddd, dd MMMM yyyy");
                ...
                if (applicantdetails.postalstate != null)
                    postaladdress += "<br/>" + applicantdetails.postalstate + ", " + objCommon.GetCountryDiscription(Convert.ToInt32(applicantdetails.postalcountry));
                ...
                if (!string.IsNullOrEmpty(clarification_response_question40))
                    Nationality_of_Spouse = clarification_response_question40;
