...
public partial class admin_ec_truefalse_create : System.Web.UI.Page
{
    ...
    ec_truefalse_question_master objmapping = new ec_truefalse_question_master();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null && Request.QueryString["id"].ToString() != "")
        {
            ...
            {
                objmapping = db.ec_truefalse_question_master.Where(obj => obj.id == mcqID).FirstOrDefault();
                if (objmapping == null)
                    mcqID = -1;
            }
        }
    ...
    private void popuate(int mcqID)
    {
        try
        {
            var data = db.ec_truefalse_question_master.Where(x => x.id == mcqID).FirstOrDefault();
            if (data != null)
            {
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (mode == "new")
                db.ec_truefalse_question_master.Add(objmapping);
            db.SaveChanges();
            if (mode == "new")
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage",
                 "alert('Record Inserted Successfully');window.location='" + Request.ApplicationPath + "admin/ec_truefalse_master.aspx';", true);
            else
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage",
                 "alert('Record Updated Successfully');window.location='" + Request.ApplicationPath + "admin/ec_truefalse_master.aspx';", true);
