<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alternatedobproof.aspx.cs" Inherits="admin_alternatedobproof" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Alternate DOB Proof Master</li>
        </ol>
        <h1 class="h2">Alternate DOB Proof Master</h1>
