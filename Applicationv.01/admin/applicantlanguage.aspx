                    ...
                    <div class="list-group-item" id="QualificationType" runat="server" style="display: none">
                        <div class="form-group m-0" role="group" aria-labelledby="label-QualificationType">
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <asp:Label ID="lblQualificationType" runat="server"></asp:Label><span class="helpicon"><i id="icQualificationType" runat="server" class="fa fa-info-circle" style="display: none;"></i></span>
                                </div>
                                <div class="col-md-4">
