                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-havevisa">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblHaveVisaYes" GroupName="HaveVisa" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-visa">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvisaYes" GroupName="visa" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-validityFrom">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvalidityFromYes" GroupName="validityFrom" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-validityTo">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvalidityToYes" GroupName="validityTo" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-visano">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvisanoYes" GroupName="visano" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-visaappliedCountry">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvisaappliedCountryYes" GroupName="visaappliedCountry" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-city">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvisacityYes" GroupName="visacity" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-highschoolCountry">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblvisacountryYes" GroupName="visacountry" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-firstvisit">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblfirstvisitYes" GroupName="firstvisit" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-Previuosstay">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblPreviuosstayYes" GroupName="Previuosstay" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-parent">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblparentYes" GroupName="parent" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-DeniedVisa">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblDeniedVisaYes" GroupName="DeniedVisa" Text="Yes" runat="server" />
                    ...
                    <div class="form-group m-0" role="group" aria-labelledby="label-parentdeny">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RadioButton ID="rblparentdenyYes" GroupName="parentdeny" Text="Yes" runat="server" />
