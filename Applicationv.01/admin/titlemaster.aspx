<%@ Page Language="C#" AutoEventWireup="true" CodeFile="titlemaster.aspx.cs" Inherits="admin_titlemaster" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Title Master</li>
        </ol>
        <h1 class="h2">Title Master</h1>
        ...
        <div class="card">
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <asp:GridView ID="gvTitle" runat="server" CssClass="table" AutoGenerateColumns="False" ShowFooter="true"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="titleid" HeaderText="ID" InsertVisible="False"
                                ReadOnly="True" SortExpression="titleid" />
                            ...
                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtDescription" CssClass="form-control" TextMode="MultiLine" runat="server" Text='<%# Bind("titlename") %>'></asp:TextBox>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblDescription" runat="server" Text='<%# Bind("titlename") %>'></asp:Label>
