<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coursetype.aspx.cs" Inherits="admin_coursetype" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Course Type Master</li>
        </ol>
        <h1 class="h2">Course Type Master</h1>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Course Type" SortExpression="coursetype">
                                <EditItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator runat='server' ID='requiredDescEdit' ValidationGroup='<%# "Group_" + Container.DataItemIndex %>' Display="Dynamic" ErrorMessage='Course Type Cannot Be Empty' ControlToValidate='txtDescription' />
                                </EditItemTemplate>

                                <FooterTemplate>

                                    <asp:TextBox ID="txtDescription1" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat='server' ID='requiredDescFooter' ValidationGroup='<%# "GroupF_" + Container.DataItemIndex %>' ErrorMessage='Course Type  Cannot Be Empty' ControlToValidate='txtDescription1' />
                                </FooterTemplate>
