<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createmanageaccomdation.aspx.cs" Inherits="admin_createmanageaccomdation" MasterPageFile="~/admin/admin.master" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="container page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Create Accommodation Plan</li>
        </ol>

        <h1 class="h2">Create Accommodation Plan</h1>
