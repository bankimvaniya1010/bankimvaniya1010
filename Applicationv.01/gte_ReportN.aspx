<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gte_ReportN.aspx.cs" Inherits="gte_ReportN"%>
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
  ...
  <body>
    ...
    <div runat="server" id="btnDiv" class="form-row justify-content-between" style="display: none;margin-left: 810px;width: 50%;padding: 10px;">
            <asp:Button ID="backNavLink" runat="server" class="btn btn-success" Text="Back" onclick="backNavLink_Click" Visible="false"/>
            <asp:Button ID="btnDownload" runat="server" CssClass="btn btn-success" Text="Download Report" OnClick="btnDownload_Click" Visible="false"/>
        </div>
    ...
    <div class="certificate-wrpr">
        ...
        <table class="certificate-table" cellspacing="0" cellpadding="0">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" class="usr-info-table">
                        <tr>
                            ...
                            <td class="rgt-img"><img src="<%=recommendationURL %>" width="150px" height="200px"/></td>
                        </tr>
                    </table>
                </td>
            </tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td class="recm-txt-img">
                                          <div class="">
                                              <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/GTEReport/Capture375.png">
                                          </div>                           
                                        </td>
                                        <td>
                                          <div class="clearfix">
                                           ...
                                           <div class="<%=blck_cls_servity_final %>">
                                            ...
                                            <div class="recm-caaut-wrpr" runat="server" id="rp1">
                                              <img src="<%=recommendedwithcaution %>">
                                              <div class="recm-caaut-txt">
                                                <%=recommendtionText %>
                                              </div>
                                            </div>
                                              <div class="recm-caaut-wrpr" runat="server" id="fd1" style="display:none;">
                                          ...
                                          <td class="graph-td" style="display:none;">
                                            ...
                                            <%--  <asp:Chart ID="Chart1" runat="server" Width="500px">
                                                  <Series>
                                                      ...
                                                      <asp:Series ChartType="Bubble" Name="Growth" XValueMember="country" YValueMembers="growth"
                                           ...
                                           <asp:Chart ID="Chart1" runat="server" BackGradientStyle="TopBottom"
                                                  BorderlineWidth="0" Height="373px" Palette="None" PaletteCustomColors="128, 64, 0"
                                                  Width="333px" BorderlineColor="Black" BorderlineDashStyle="Dot" BackColor="Transparent">
                                                  <Series>
                                                      <asp:Series ChartArea="ChartArea1" ChartType="FastPoint" Name="Series2" YValuesPerPoint="2">
                                                      </asp:Series>
                                                      <asp:Series ChartArea="ChartArea1" ChartType="Bubble" Name="Series3" IsValueShownAsLabel="true">
                                                      </asp:Series>
                                                  </Series>
                                                 <ChartAreas>
                                                      
                                                      <asp:ChartArea Name="ChartArea1" BorderColor="DimGray" BorderWidth="0" ShadowColor="255, 192, 192" BackColor="White">
                                                         <AxisX Title="<----LOW----RISK LEVEL-----HIGH---->" IsMarginVisible="true" TitleFont="Microsoft Sans Serif, 8pt, style=Bold" TitleForeColor="Red">
                                                              
                                                              <LabelStyle ForeColor="Red" />
                                                         </AxisX>
                                                          <AxisY Title="<----LOW----SATISFACTION LEVEL-----HIGH---->" Interval="25" IntervalType="Number" Maximum="100" Minimum="0" TitleFont="Microsoft Sans Serif, 8pt, style=Bold" TitleForeColor="Green" >
                                                              
                                                               <LabelStyle ForeColor="Lime" />
                                                              <ScaleBreakStyle LineColor="Red" />
                                                          </AxisY>
            ...
            <LabelStyle Font="Segoe UI, 9pt" />
                                                         ...
                                                         <%-- <AxisX Interval="20" Maximum="100" Minimum="0" Title="adadasd">
                                                              <MinorGrid Enabled="True" Interval="20" />
                                                          </AxisX>--%>
                                          ...
                                          <td style="display:none;">
                                              <table style="margin-left:-16px;">
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-darkblue" style="width: 2px;height: 6px;">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Previous Study and Gaps</td>
                                                  </tr>
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-orange" style="width: 2px;height: 6px; color:orange">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Value of Course</td>
                                                   </tr>
                                                   <tr>
                                                          <td>
                                                              <div class="criteria-tbl-box bg-dimgray" style="width: 2px;height: 6px; color:dimgray">
                                                              </div>
                                                          </td>
                                                          <td class="criteria-tbl-sb-hding textalign">Situations in Home Country</td>
                                                   </tr>
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-yellow"  style="width: 2px;height: 6px; color:yellow">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Potential Situation in Australia</td>
                                                  </tr>
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-cornflowerblue" style="width: 2px;height: 6px; color:cornflowerblue">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Immigration History</td>
                                                  </tr>
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-green-l" style="width: 2px;height: 6px; color:lightgreen">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Conversion & Retention Risk</td>
                                                  </tr>
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-blueviolet" style="width: 2px;height: 6px; color:blueviolet">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Character & Criminal Record</td>
                                                  </tr>
                                                  <tr>
                                                      <td>
                                                          <div class="criteria-tbl-box bg-chocolate" style="width: 2px;height: 6px; color:chocolate">
                                                          </div>
                                                      </td>
                                                      <td class="criteria-tbl-sb-hding textalign">Understanding of Visa Requirements</td>
                                                  </tr>
                                              </table>
                                          </td>
                                      </tr>
      ...
      <%--2--%>
    <div class="certificate-wrpr" style="page-break-before: always; page-break-after: always;" runat="server" id="page2_rp">
        <div class="water-mark"><%=gtereportNo %></div>
        <table class="certificate-table" cellspacing="0" cellpadding="0">
            <tr>
                <td>
                        ...
                        <tr>
                          <td>
                            <div class="section-ttle">
                                <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/GTEReport/Capture373.png">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width:100%;">
                              <tr>
                                ...
                                <td class="barcoder-wrpr" id="QR_verificationDiv" runat="server">
                                      <div id="qrcode1" style="width:100px;"></div>
...
country and have not had any outstanding debts to the Government or any public authority in <%=CountryIamapplyingtoStudy %>. 
          ...
          <%--page2 feedback--%>
          <div class="certificate-wrpr" runat="server" id="page2_fd" style="display:none;">
        <div class="water-mark"><%=gtereportNo %></div>
        <table class="certificate-table" cellspacing="0" cellpadding="0">
            <tr>
                <td>
                          ...
                          <td>
                            <table cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td class="barcoder-wrpr" id="Td1" runat="server">
                                      <div id="qrcode1"></div>
                                  <%--<img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>\assets\GTEReport\barcoder-y.png">--%>
                                </td>
                              </tr>
...
country and have not had any outstanding debts to the Government or any public authority in <%=CountryIamapplyingtoStudy %>. 
      ...
      <%--3--%>
    <div class="certificate-wrpr" style="page-break-before: always; page-break-after: always;">
        <div class="water-mark"><%=gtereportNo %></div>
        <table class="certificate-table" cellspacing="0" cellpadding="0">
            <tr>
                <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <table cellpadding="0" cellspacing="0">
                            ...
                            <table cellpadding="0" cellspacing="0">
                              <tr>
                                <td>
                                  <div class="sec-6-img">
                                   <div class="">
                                       <img src="<%=ConfigurationManager.AppSettings["WebUrl"].Replace("#DOMAIN#", Request.Url.Host.ToLower()).ToString() %>/assets/GTEReport/Capture372.png"> 
                                   </div> 
                                  </div>
                        ...
                        <tr>
                          <td class="pt-20">
                                <table cellpadding="0" cellspacing="0" class="cer-btm-txt1" style="width:100%;">
                                    <tr>
                                    ...
                                    <tr>
                                      <td>
                                        <div class="cer-note-wrpr pt-20">NOTE: The Genuine Student and Genuine Temporary Entrant Tutorial and Certification of Understanding helps in reducing risks related to Visa Refusals (fraud and non-fraud), Visa Cancellations and Turning unlawful. These factors account for 90% of an education providers Immigration Risk Rating based on the SSVF framework.</div>
                                      </td>
                                    </tr>
                                </table>
                            </td>
                              ...
                              <tbody><tr>
                                <td>
                                  ...
                                  <div class="clearfix cd-info-box-wrpr">
                                    ...
                                    <div class="cd-info-box">
                                      <div class="cd-info-ttl"><%=Isoffshoretxt %></div>
                                ...
                                <td>
                                  <div class="clearfix cd-info-box-wrpr">
                                    ...
                                    <div class="cd-info-box bg-red wid-107" style="width:107px;">
                                      ...
                                      <div class="cd-info-subttl3" style="font-size:10px!important;"><%=workexpericeyears %></div>
                                    </div>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                              <tbody><tr>                          
                                 ...
                                 Clarification<br/> Questions
                                  ...
                                  <td>
                                  <div class="us-msg-wrpr" style="width: 471px;height: 175px;">
    ...
    <div class="certificate-wrpr">
        <div class="water-mark"><%=gtereportNo %></div>
          ...
          <div style="margin-left: 45%;display:none;" id="fdbtn" runat="server">
