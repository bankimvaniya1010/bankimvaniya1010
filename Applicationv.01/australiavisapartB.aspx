...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div runat="server" id="question30">
                                        ...
                                        <div class="comm-txt">
                                            You <b>must</b> provide <b>evidence</b> of your study and training, including academic records, if you are:
            <ul>
                ...
                <li>in Assessment Level 2 seeking to undertake studies in the postgraduate research sector.</li>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" onchange="hideshowdocument();" name="doct-attched" runat="server" id="eduProviderdocattachedNo">No
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="doct-attched" onchange="hideshowdocument();" runat="server" id="eduProviderdocattachedYes">Yes
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group" id="divdocument">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="eductn-attched" runat="server" id="othercoursedocattachedNo">No
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="eductn-attched" runat="server" id="othercoursedocattachedYes">Yes
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="divothercoursedocument">
                                                    <label>Document:</label>
                                            ...
                                            <li>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="eductn-attched1" runat="server" id="othercoursedocattachedNo1">No
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="eductn-attched1" runat="server" id="othercoursedocattachedYes1">Yes
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="divothercoursedocattachedYes1">
                                                    <label>Document:</label>
                                                    <asp:Label ID="Label3" runat="server" />
                                                    <asp:FileUpload ID="fileUploadothercoursedocattached" runat="server" />
                                                    <label runat="server" id="Label4" />
                                                    <input type="hidden" id="Hidden2" runat="server" />
                                                    <asp:HyperLink runat="server" ID="HyperLink2" Target="_blank"></asp:HyperLink>
            ...
            <ul>
                ...
                <li><b>if applying outside Australia as an Assessment Level 3 or 4 student</b>, the original ‘offer of a place in a course’ letter from your education provider. If you are assessed as a genuine student, the Australian Government office will provide you with a letter of genuineness. Only at this stage should you pay any tuition fees and obtain an electronic Confirmation of Enrolment.</li>
                                    ...
                                    <div runat="server" id="question35">
                                        <label>
                                            <b class="ques-lbl">35)</b>Have you studied for at least 5 years (in the English language) in one or more of the following countries:
            <ul>
                <li>Australia;</li>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="form-group" runat="server">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="leavingdocAttch" runat="server" id="rbdocattachedNo">No
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="leavingdocAttch" runat="server" id="rbdocattachedYes">Yes
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="divdocattachedYes">
                                                    <label>Document:</label>
                                                    <asp:Label ID="Label7" runat="server" />
                                                    <asp:FileUpload ID="fileUploaddocattachedYes" runat="server" />
                                                    <label runat="server" id="Label8" />
                                                    <input type="hidden" id="Hidden4" runat="server" />
                                                    <asp:HyperLink runat="server" ID="HyperLink4" Target="_blank"></asp:HyperLink>
                                            ...
                                            <li>
                                                ...
                                                <div class="form-group" runat="server">
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="leaving-docAttch" runat="server" id="rbdocattachedNo1">No
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" onchange="hideshowdocument()" name="leaving-docAttch" runat="server" id="rbdocattachedYes1">Yes
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="divdocattachedYes1">
                                                    <label>Document:</label>
                                                    <asp:Label ID="Label5" runat="server" />
                                                    <asp:FileUpload ID="fileUploaddocattachedYes1" runat="server" />
                                                    <label runat="server" id="Label6" />
                                                    <input type="hidden" id="Hidden3" runat="server" />
                                                    <asp:HyperLink runat="server" ID="HyperLink3" Target="_blank"></asp:HyperLink>
    ...
    <script>  
        ...
        function validateform() {
            ...
            else if ($("#<%=eduProviderdocattachedYes.ClientID%>").is(':checked') == true && $("#<%=fileUpload.ClientID%>").val() == "") {
                    alert("Please upload document 30");
            }
            else if ($("#<%=eduProviderdocattachedYes.ClientID%>").is(':checked') == true && !validfileExtention($("#<%=fileUpload.ClientID%>").val()))
                alert("Please upload valid file format");
            else if ($("#<%=othercoursedocattachedYes.ClientID%>").is(':checked') == true && ($("#<%=fileUploadcourse.ClientID%>").val() == "")) {
                    alert("Please upload document 30");
            }
            else if ($("#<%=othercoursedocattachedYes.ClientID%>").is(':checked') == true && !validfileExtention($("#<%=fileUploadcourse.ClientID%>").val()))
                alert("Please upload valid file format");
            else if ($("#<%=othercoursedocattachedYes1.ClientID%>").is(':checked') == true && $("#<%=fileUploadothercoursedocattached.ClientID%>").val() == "") {
                    alert("Please upload document 30");
            }
            else if ($("#<%=othercoursedocattachedYes1.ClientID%>").is(':checked') == true && !validfileExtention($("#<%=fileUploadothercoursedocattached.ClientID%>").val()))
                alert("Please upload valid file format");
            //31
            ...
            else if ($("#<%=rbdocattachedYes1.ClientID%>").is(':checked') == true && $("#<%=fileUploaddocattachedYes1.ClientID%>").val() == "") {
                alert("Please upload document 36");
            }
            else if ($("#<%=rbdocattachedYes.ClientID%>").is(':checked') == true && $("#<%=fileUploaddocattachedYes.ClientID%>").val() == "") {
                    alert("Please upload document 36");
            }
            else if ($("#<%=rbdocattachedYes.ClientID%>").is(':checked') == true && !validfileExtention($("#<%=fileUploaddocattachedYes1.ClientID%>").val()))
                alert("Please upload valid file format");
            else if ($("#<%=rbdocattachedYes.ClientID%>").is(':checked') == true && !validfileExtention($("#<%=fileUploaddocattachedYes.ClientID%>").val()))
                alert("Please upload valid file format");
            //37
        ...
        $(document).ready(function () {
            $("#divdocument").hide();
            $("#divothercoursedocument").hide();
            $("#divothercoursedocattachedYes1").hide();
            $("#divdocattachedYes1").hide();
            $("#divdocattachedYes").hide();
        ...
        function hideshowdocument() {
            debugger;
            if ($("#<%=eduProviderdocattachedYes.ClientID%>").is(':checked') == true) {
                $("#divdocument").show();
            }
            else {
                $("#divdocument").hide();
            }
            if ($("#<%=othercoursedocattachedYes.ClientID%>").is(':checked') == true) {
                $("#divothercoursedocument").show();
            }
            else {
                $("#divothercoursedocument").hide();
            }
            if ($("#<%=othercoursedocattachedYes1.ClientID%>").is(':checked') == true) {
                $("#divothercoursedocattachedYes1").show();
            }
            else {
                $("#divothercoursedocattachedYes1").hide();
            }
            if ($("#<%=rbdocattachedYes.ClientID%>").is(':checked') == true) {
                $("#divdocattachedYes").show();
            }
            else {
                $("#divdocattachedYes").hide();
            }
            if ($("#<%=rbdocattachedYes1.ClientID%>").is(':checked') == true) {
                $("#divdocattachedYes1").show();
            }
            else {
                $("#divdocattachedYes1").hide();
            }
