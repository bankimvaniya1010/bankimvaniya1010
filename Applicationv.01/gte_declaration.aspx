                        ...
                        <div class="card-body list-group list-group-fit">
                          ...
                          <%--if gTE --%>
                                <div runat="server" style="display:none;" id="gtedecDiv">
                                    <div><%--style="margin-left: 602px;margin-top: -134px;margin-bottom:66px;"--%>
                                    <asp:Button ID="btnDownload" runat="server" CssClass="btn btn-success" Text="Download" OnClick="btnDownload_Click" Visible="true"/></div>
                    ...
                    <td>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <div class="list-group-item">
                             ...
                             <% if (allStatements.Count > 0 || isFullService == 0)
                                 { 
                                     %>
