<%@ Page Language="C#" AutoEventWireup="true" CodeFile="predeparturetutorial.aspx.cs" Inherits="predeparturetutorial" MasterPageFile="~/student.master"%>
    ...
    <script>
        ...
        function openLink(url) {
          ...
          $(document).ready(function () {
              ...
              $('#predeparture_list').addClass('open');
