...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" runat="server" id="knownbyanothername">
                                                    ...
                                                    <div id="anothernamesbloack" runat="server">
                                                        <br>
                                                        <div class="form-group">
							...
							<asp:DropDownList ID="ddlcountryofBirth" CssClass="form-control" runat="server">
                                                ...
                                                <div class="form-group" id="anothercitizenship" runat="server">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div id="ddanothercitizenship" runat="server">
                                                            <br>
                                                            <div class="form-group">
                                                ...
                                                <div class="form-group" id="havepassport" runat="server">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div id="passportControls" runat="server">
                                                            <br>
                                                            ...
                                                            <div class="form-group" id="dateofissue" runat="server">
                                                                ...
                                                                <input id="txtdateofissue" runat="server" onchange="dateCompare()" type="text" class="form-control" placeholder="Date of Issue" data-toggle="flatpickr" value="">
                                                            </div>
                                                            <div class="form-group" id="expirydate" runat="server">
                                                                <label>Date of expiry</label>
                                                                <input id="txtexpirydate" runat="server" type="text" onchange="dateCompare()" class="form-control" placeholder="Expiry Date" data-toggle="flatpickr" value="">
                                                            </div>
                                                ...
                                                <div class="form-group" id="residenceaddress" runat="server">
                                                    <label>
                                                        <b class="ques-lbl">16)</b>Your residential address in your Home country
                             <br />
                                                        <b>Note:</b>A post office box address is not applicable as residential address .Failure to give your residential address  will result
                              in your application being invalid.
                                                ...
                                                <div class="form-group" id="australiaresidentialadd" runat="server">
                                                    <label>
                                                        <b class="ques-lbl">18)</b>Your residential address in Australia(if known)
                                                    </label>
                                                    <div class="mart-stustwrp">
                                                        <div class="">
                                                            <div class="form-group">
                                                ...
                                                <div class="form-group" id="correspondenceaddress" runat="server">
                                                    <label>
                                                        <b class="ques-lbl">20)</b>Address of Correspondence
                                                    </label>
                                                    <div class="mart-stustwrp">
                                                        <div class="">
                                                            <div class="form-group">
                                                ...
                                                <!-- ques 22 start -->
                                                <div class="frm-lblttl"><b>About your family</b></div>
                                                <div>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Date of birth</label>
                                                                    <input id="txtfamilymemberdob1" runat="server" type="text" class="form-control" placeholder="Date of birth" data-toggle="flatpickr" value="">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Is this person included in this application? </label>
                                                                    <div class="form-check-inline">
                                                        ...
                                                        <li>
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Date of birth</label>
                                                                    <input id="txtfamilymemberdob2" runat="server" type="text" class="form-control" placeholder="Date of birth" data-toggle="flatpickr" value="">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Is this person included in this application? </label>
                                                                    <div class="form-check-inline">
                                                ...
                                                <!-- ques 22 end -->
                                                <!-- ques 23 start -->
                                                <div class="frm-lblttl"><b>Dependants under 18 years of age</b></div>
                                                <div>
                                                    <div class="form-group">
                                                ...
                                                <div>
                                                    <div class="form-group">
                                                        <label><b class="ques-lbl">24)</b><b> you have the sole legal right to determine where any dependants under 18 years of age who are included in this application will live or to remove each such dependant from their country of usual residence?</b></label>
                                                        <div class="form-check-inline">
                                                            <label class="form-check-label">
                                                ...
                                                <div>
                                                    <label>
                                                        <b class="ques-lbl">25)</b> Are any of your dependants who are under 18 years of age, and who are included in this application, the subject of a court order giving you:		
                                                        <ul>
                                                ...
                                                <div>
                                                    <div class="form-group">
                                                        <div class="frm-lblttl"><b>Previous Visa Application</b></div>
    ...
    <script>
        ...
        function dateCompare() {
            ...
            if (d1 >= d2) {
                alert('DATE OF ISSUE is earlier than DATE OF EXPIRY ');
        ...
        $(document).ready(function () {
            ...
            $("#<%=visagrantedNo1.ClientID%>").change(function (e) {
                var value = $("#<%=visagrantedNo1.ClientID%>").val();
             if (value.length != 13) {
                 alert("Provide the 13-digit visa grant number");
                    $("#<%=visagrantedNo1.ClientID%>").focus();
                    return false;
                }

            });

            $("#<%=txtplaceofissue1.ClientID%>").keypress(function (e) {
            ...
            $("#<%=txtaboutfamilyname.ClientID%>").keypress(function (e) {
            ...
            $("#<%=txtanoutfamilyGivenname1.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtrelationship.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtcitizen.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansfamilyname.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansgivenname.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansresidentialaddress.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansrelationship.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardianslegalrights.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansfamilyname1.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansgivenname1.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansresidentialaddress1.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardiansrelationship1.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardianslegalrights1.ClientID%>").keypress(function (e) {
                var regex = new RegExp("^[a-zA-Z ]+$");
                var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                if (!regex.test(strigChar)) {
                    return false;
            ...
            $("#<%=txtguardianspostalcode1.ClientID%>").keypress(function (e) {
                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#<%=txtguardianscontactno1.ClientID%>").keypress(function (e) {
                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            ...
            $("#<%=txtguardianspostalcode.ClientID%>").keypress(function (e) {
                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#<%=txtguardianscontactno.ClientID%>").keypress(function (e) {
                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });

            $("#<%=txtapplicableidentificationno.ClientID%>").keypress(function (e) {
                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
        ...
        $("#<%=anotherIdentitytype1.ClientID%>").keypress(function (e) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                return false;
            }
        });
        $("#<%=officehrContactNo.ClientID%>").keypress(function (e) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                return false;
            }
        });
        $("#<%=afterhrContactNo.ClientID%>").keypress(function (e) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                return false;
            }
        });
        $("#<%=officehrContactNoInAustralia.ClientID%>").keypress(function (e) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                return false;
            }
        });
        $("#<%=afterhrContactNoInAustralia.ClientID%>").keypress(function (e) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                return false;
            }
        });
        ...
        $("#<%=txtnoOfPeople.ClientID%>").keypress(function (e) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                return false;
            }
        });
        $("#<%=txtfamilyname.ClientID%>").keypress(function (e) {
            var regex = new RegExp("^[a-zA-Z ]+$");
            var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
            if (!regex.test(strigChar)) {
                return false;
        ...
        $("#<%=txtownLanguageName.ClientID%>").keypress(function (e) {
            var regex = new RegExp("^[a-zA-Z ]+$");
            var strigChar = String.fromCharCode(!e.charCode ? e.which : e.charCode);
            if (!regex.test(strigChar)) {
                return false;
        ...
        $("#<%=txtpassportno.ClientID%>").change(function (e) {
            var value = $("#<%=txtpassportno.ClientID%>").val();
             if (value.length != 10) {
                 alert("Passport number only accept 10 digit");
