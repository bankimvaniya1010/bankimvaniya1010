<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_Bassignment.aspx.cs" Inherits="view_Bassignment" MasterPageFile="~/student.master"%>
                                ...
                                <asp:Panel ID="options" runat="server">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="openanswer" style='<%= openanswer == "" ? "display:none;": "display:block;"  %>'>
                                            <div class="media-body">
                                                <h4 class="card-title">
                                                    <label id="lblopenans" style="<%# Eval("openanswertype") == null? "display: block;": "display:none;"%>"><%# Eval("answer1") %></label>
    ...
    <script>
        ...
        if (is_onetimeshow == 1) {
            ...
            aud.onended = function () {
                $.ajax({
                type: "POST",
                url: "view_Bassignment.aspx/Saveaudiovideoresponse",
