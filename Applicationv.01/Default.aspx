            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div id="service_gte_instructions" runat="server" style="display:none">
                        ...
                        <p>
                           To ensure you benefit from this service, and get an accurate evaluation report and generate a factual SOP (Statement of Purpose). it is very important that you are honest and genuine with your responses to the assessment questions and upload only genuine documents.
                        </p>
                        <p>
                ...
                <div class="" id="questions" runat="server" style="border: black;border-style: groove !important;">
                    <div class="card-body">
                        ...
                        <div style="font-size: 19px;">
                                    <b>Benifits of GTE DIRECT for International Students:</b>
                                    <table style="font-size:13px;">
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TabFirst_Icon.png" class="img_defltpg"></td>
                                            <td class="paddingleft">Get first-hand knowledge of the A to Z of Student Visas and GTE ( GenuineTemporary Entrant)</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagSecond_Icon.png" class="img_defltpg"></td>
                                            <td class="paddingleft">Get an Independent Certification of Understanding of Student Visa and Genuine</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagThree_Icon.png" class="img_defltpg"></td>
                                            <td class="paddingleft">Post your evaluation get a detailed Counsellor’s Report on how to minimize your refusal risks.</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagFour_icon.png" class="img_defltpg"></td>
                                            <td class="paddingleft">Based on your responses get an Artificial Intelligence driven, factual SOP (Statement of Purpose) draft.</td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div style="font-size: x-large;">
                                    ...
                                    <table border="1">
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TabFirst_Icon.png"></td>
                                            <td>Get first-hand knowledge of the A to Z of Student Visas and GTE ( GenuineTemporary Entrant)</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagSecond_Icon.png"></td>
                                            <td>Get an Independent Certification of Understanding of Student Visa and Genuine</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagThree_Icon.png"></td>
                                            <td>Post your evaluation get a detailed Counsellor’s Report on how to minimize your refusal risks.</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagFour_icon.png"></td>
                                            <td>Based on your responses get an Artificial Intelligence driven, factual SOP (Statement of Purpose) draft.</td>
                                        </tr>
                                        <tr>
                                            <td><img src="assets/images/menu_icons/TagFive_icon.png"></td>
                                            <td>If additionally opted for, get your Visa documents independently verified and validated by experts</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
