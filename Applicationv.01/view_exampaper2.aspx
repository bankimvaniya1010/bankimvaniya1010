                                    ...
                                    <asp:Panel ID="options" runat="server">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="uploadanswer" style='<%= uploadanswer == "" ? "display:none;": "display:block;"  %>'>
                                                ...
                                                <div class="form-group row" id="extrafiledocument" style="<%# (Eval("upload_extrasheetpath") == null && Eval("upload_fileinstruction") == null && Eval("upload_filepath") == null)? "visibility: hidden;": " "  %>">
