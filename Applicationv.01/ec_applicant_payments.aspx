<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_applicant_payments.aspx.cs" Inherits="ec_applicant_payments" MasterPageFile="~/student.master"%>
                    ...
                    <div class="card">
                        <div class="tab-content card-body">
                            ...
                            <div class="table-responsive" data-toggle="lists" data-lists-values='["name"]'>
                                <asp:GridView ID="paymentsGridView" CssClass="table" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="false" CellPadding="3"
                                    PageSize="25"
                                    BorderStyle="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Payment Verified">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblpaymentstatus_ID" runat="server" Text='<%# Bind("paymentstatus_ID") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
