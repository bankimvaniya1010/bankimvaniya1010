<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ec_UploadAnswerSheet.aspx.cs" Inherits="ec_UploadAnswerSheet" %>
    ...
    <script>
        var pagebackDone ='<%=pagebackDone%>';
          function ajaxcalltocheckisanswersubmitted() {
            ...
            $.ajax({
                type: "POST",
                url: "ec_UploadAnswerSheet.aspx/isanswersubmitted",
                ...
                success: function (response) {
                    if (response.d) {
                        ...
                        if (result != "NOresponsesubmitted") {
                            ...
                            location.replace(hostName + "ec_UploadAnswerSheet.aspx?ID=" + <%=assignID%>);
                        }
                    }
                }
            });
        ...
        function validatForm() {
            ...
            var answersheet = $("#<%=FileUpload.ClientID%>").val();
             ...
             if (flag) {
                ...
                req.open("POST", 'ec_UploadAnswerSheet.aspx/uploadVideo', true);
                req.send(formData);
            }
            return false;
        }
            ...
            <div class="card-body">
                ...
                <div runat="server" id="ifanswersubmitted" style="display: none">
                    <div runat="server" id="Div1" class="form-row justify-content-between" style="margin: auto; width: 50%; padding: 10px;">
                        <label id="lblmsg" runat="server"><b>You have already submitted this Assignments</b></label>
                    </div>
                </div>
            </div>
        </div>
