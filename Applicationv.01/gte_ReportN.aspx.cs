...
public partial class gte_ReportN : System.Web.UI.Page
{
    public int overallscore_;
    public string AL_Level,tag8_class1, tag8_class2, tag8_class3, retrentionrisk_decision, VerificationvideoURL, recommendtionText,courseapplied, packagapplied, institutionapplied, gtereportNo, universityid, candidateno, logourl, recommendationURL, chkboxURL4_1, chkboxURL4_2, chkboxURL4_3, CountryIamapplyingtoStudy,
        ...
        institutionNo, facilitingagent, sponsoringclient, passportno, countryofresidence, nationality, gender, dateofbirth, middlename="none", firstname, familyname, reportsubmitteddate, ipaddress,
        ...
        citizenship, age, Isoffshore, Isoffshoretxt, maritalstatus, marriedyears, spousecitizenship, Isdependent, noofdependents, sec3_46_class, tag1clr, tag2clr, tag3clr, tag4clr, tag5clr, tag6clr, tag7clr, tag8clr,
       ...
       , RGcmnt_sec2_13, RGcmnt_sec2_14, RGcmnt_sec2_15, RGcmnt_sec2_16, RGcmnt_sec2_17, RGcmnt_sec2_18, evidence_doc, previoussttudy_gaps_doclist, situationhomecountry_doclist, valude_doclist, potentionalsituation_doclist, immigration_doclist, knowledge_doclist
        ...
        high_taglist=null,previous_blockclass1, previous_blockclass2, previous_blockclass3, previous_score1, previous_score2, previous_score3, previous_percentage1, previous_percentage2, previous_percentage3, employment_percentage1, employment_percentage2, employment_percentage3, employment_blockclass1, employment_blockclass2, employment_blockclass3, employment_score1, employment_score2, employment_score3;

    public int ApplicantID = 0, universityID = 0, aid=0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["feedback"] != null)
            feedback = Convert.ToInt32(Request.QueryString["feedback"]);
        if (feedback == 1)
        {
            rp1.Attributes.Add("style", "display:none;");
            fd1.Attributes.Add("style", "display:block;");
            page2_fd.Attributes.Add("style", "display:block;");
            page2_rp.Attributes.Add("style", "display:none;");
            ...
            if (data != null)
            {
                ...
                rp1.Attributes.Add("style", "display:block;");
                page2_rp.Attributes.Add("style", "display:block;");
                page2_fd.Attributes.Add("style", "display:none;");
                if (data.reported_date == null)
                {
                    fdbtn.Attributes.Add("style", "margin-left: 45%;display:block;");
                    rp1.Attributes.Add("style", "display:none;");
                    fd1.Attributes.Add("style", "display:block;");
                    page2_fd.Attributes.Add("style", "display:block;");
                    page2_rp.Attributes.Add("style", "display:none;");
    ...
    private void showContent(string CID) {
        try
        {
            ...
            if (Personal != null)
            {
                ...
                if (Personal.nameofuniversityappliedfor != null)
                    ViewState["eduInstitution"] = objCom.GetUniversityName(Convert.ToInt32(Personal.nameofuniversityappliedfor));
                ...
                {
                    Isoffshore = "YES"; Isoffshoretxt = "ONSHORE";
                }
                else
                {
                    Isoffshore = "NO"; Isoffshoretxt = "OFFSHORE";
                }
                ...
                pg2_s3_31 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 31);
                ...
                pg2_s3_32 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 32);
                ...
                pg2_s3_33 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID,33 );
                ...
                pg2_s3_34 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 34);
                ...
                pg2_s3_35 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 35);
                ...
                pg2_s3_36 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 36);
                ...
                pg2_s3_37 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 37);
                ...
                pg2_s3_3839 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 38);
                ...
                pg2_s3_40 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 40);
                ...
                pg2_s3_41 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 41);
                ...
                pg2_s3_42 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 42);
                ...
                pg2_s3_43 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 43);
                ...
                pg2_s3_44 = "crm-box-wrpr " + objCom.GetSection3AnswerNew(ApplicantID, 44);
                ...
                if (gteprogressbar != null)
                {
                    ...
                    string[] inputs = gteprogressbar.gte_perdentage_score.Split('.');
                    overallscore = inputs[0];
                    overallscore_ =Convert.ToInt32(inputs[0]);
                ...
                classPS_10_1 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 1);
                ...
                classPS_10_2 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 2);
                ...
                classPS_10_3 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 4);
                ...
                classPS_10_4 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 6);
                ...
                classPS_10_5 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 7);
                ...
                classPS_10_6 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 9);
                ...
                classPS_10_7 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 12);
                ...
                classPS_10_9 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 15);
                ...
                { classPS_10_10 = "cd-info-box bg-red"; PSbox10_10 = "YES";
                    classPS_10_10 = "cd-info-box " + objCom.GetSection_auto_classclr(10, 0);
                }
                else { classPS_10_10 = "cd-info-box bg-green-l"; PSbox10_10 = "NO";
                    classPS_10_10 = "cd-info-box " + objCom.GetSection_auto_classclr(10, 0);// decide by himanshu sir to send largent number
                }

                //s3/A12/T=Y
                if (levelodstudy_systemlevel == 0)
                { classPS_10_11 = "cd-info-box bg-red"; PSbox10_11 = "YES";
                    classPS_10_11 = "cd-info-box " + objCom.GetSection_auto_classclr(12, 1);
                }
                else
                { classPS_10_11 = "cd-info-box bg-green-l"; PSbox10_11 = "NO";
                    classPS_10_11 = "cd-info-box " + objCom.GetSection_auto_classclr(12, 0);
                }
                ...
                if (Personal.broadFieldID != 12)
                {
                    if (Personal.narrowFieldID != 68)
                    {
                        if (Personal.broadFieldID != Personal.broadFieldIDyouwillComplete)
                        {
                            ...
                            classPS_10_12 = "cd-info-box " + objCom.GetSection_auto_classclr(16, 1);
                        }
                        else
                        {
                            classPS_10_12 = "cd-info-box bg-green-l"; PSbox10_12 = "NO";
                            classPS_10_12 = "cd-info-box " + objCom.GetSection_auto_classclr(16, 0);
                        }
                    }
                    else
                    {
                ...
                if (Personal.broadFieldID != 12)
                {
                    if (Personal.narrowFieldID != 68)
                    {
                        if (Personal.narrowFieldID != Personal.narrowFieldIDyouwillComplete)
                        {
                            ...
                            classPS_10_13 = "cd-info-box " + objCom.GetSection_auto_classclr(17, 1);
                        }
                        else
                        {
                            classPS_10_13 = "cd-info-box bg-green-l"; PSbox10_13 = "NO";
                            classPS_10_13 = "cd-info-box " + objCom.GetSection_auto_classclr(17, 0);
                        }
                    }
                    else
                    {
                ...
                // s3 / A18 / T = Y  IF Question 28 = None (no full time work experience)  logic cange as disccuss on call with himanshu sir on 15/5/2021

                //if (Personal.workexperience == 1)
                //{
                //    classPS_10_14 = "cd-info-box bg-red"; PSbox10_14 = "YES";
                //    classPS_10_14 = "cd-info-box " + objCom.GetSection_auto_classclr(18, 1);
                //}
                //else
                //{
                //    classPS_10_14 = "cd-info-box bg-green-l"; PSbox10_14 = "NO";
                //    classPS_10_14 = "cd-info-box " + objCom.GetSection_auto_classclr(18, 0);
                //}
                //s3/A17/T=Y
                if (Personal.detailedFieldID != Personal.detailedFieldIDyouwillComplete)
                {
                    PSbox10_10 = "YES";
                    classPS_10_14 = "cd-info-box bg-red";
                }
                else
                {
                    PSbox10_10 = "NO";
                    classPS_10_14 = "cd-info-box bg-green-l";
                }
                ...
                classRR_13_5 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 5);
                ...
                classRR_13_10 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 10);
                ...
                classRR_13_11= "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 11);
                ...
                classRR_13_29 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 29);
                ...
                classRR_13_30 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 30);
                ...
                classRR_13_49 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 49);
                ////page4.1
                ...
                AnswertoQuestion_13Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 13) + " wid-163";
                ...
                AnswertoQuestion_14Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 14) + " wid-163";
                ...
                AnswertoQuestion_15Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID,15 ) + " wid-163";
                ...
                AnswertoQuestion_16Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 16) + " wid-163";
                ...
                AnswertoQuestion_17Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 17) + " wid-163";
                ...
                AnswertoQuestion_18Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 18) + " wid-163";
                ...
                classPS_15_1 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 24);
                ...
                classPS_15_2 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 21);
                ...
                classPS_15_3 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 26);
                ...
                classPS_15_4 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 27);
                ...
                classPS_15_5 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 17);
                ...
                classPS_15_6 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 43);
                ...
                classPS_15_7 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 28);
                ...
                classPS_15_8 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 20);
                ...
                classPS_15_9 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 14);
                ...
                AnswertoQuestion_1_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 1) + " wid-163";
                ...
                AnswertoQuestion_2_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 2) + " wid-163";
                ...
                AnswertoQuestion_3_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 3) + " wid-163";
                ...
                AnswertoQuestion_4_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID,4 ) + " wid-163";
                ...
                AnswertoQuestion_5_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 5) + " wid-163";
                ...
                AnswertoQuestion_6_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 6) + " wid-163";
                ...
                AnswertoQuestion_7_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 7) + " wid-163";
                ...
                AnswertoQuestion_8_Section2_class = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 8) + " wid-163";
                ...
                class16_1 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 18) + " font7";
                ...
                class16_2 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 45) + " font7";
                ...
                class16_3 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 19) + " font7";
                ...
                class16_4 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 8) + " font7";
                ...
                class16_5 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 16) + " font7";
                ...
                class16_6 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 3) + " font7";
                ...
                class16_7 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 47) + " font7";
                ...
                class16_8 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 48) + " font7";
                ...
                class16_9 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 49) + " font7";
                ...
                class16_11 = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID,11 ) + " wid155";
                ...
                class16_10 = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID, 10) + " wid155";
                ...
                class16_12 = "cd-info-box " + objCom.GetSection_2_classclr(ApplicantID,12 ) + " wid155";
                ...
                sectin3_46 = "cd-info-box " + objCom.GetSection3AnswerNew(ApplicantID, 46) + " wid-107";
                ...
                if (!string.IsNullOrEmpty(objCom.GetClarification_applicantResponse(ApplicantID, 41)) && objCom.GetClarification_applicantResponse(ApplicantID, 41) != "0")
            ...
            foreach (var item in tag_list) {
                if (item.id != 1)
                {
                    ...
                    if (item.id == 10) {
                        ...
                        satisfaction_8 = E; block_23 = setScore_text(overallscore_, 2, 0); blck_cls_23 = setScore_class(overallscore_, 2, 0);
                        ...
                        tag8_class2 = setScore_class_perpage(overallscore_, 2, 0);
